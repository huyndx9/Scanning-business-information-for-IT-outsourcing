...
const DICT = {
  ...
  vi: {
    ...
    "cust.grade.B": "Hạng B",
    "cust.grade.C": "Hạng C",
    "cust.gradeWhy.S": "Tổng ≥ 5억, hoặc ≥ 2억 với từ 3 hợp đồng — chăm sóc ưu tiên nhất",
    "cust.gradeWhy.A": "Tổng ≥ 2억, hoặc ≥ 5천만 với từ 2 hợp đồng (khách tái ký)",
    "cust.gradeWhy.B": "Tổng ≥ 5천만",
    "cust.gradeWhy.C": "Tổng dưới 5천만 — hợp đồng đầu hoặc nhỏ",
    "cust.col.grade": "Hạng",
    ...
    "cust.form.amountHint": "vd: 2억 4000만 — bỏ trống sẽ tính = đơn giá tháng × người × số tháng",
    "cust.form.monthly": "Đơn giá tháng (M/M, KRW)",
    "cust.form.monthlyHint": "vd: 800만",
